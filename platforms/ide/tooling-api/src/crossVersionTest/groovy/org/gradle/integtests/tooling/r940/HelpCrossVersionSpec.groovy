...
class HelpCrossVersionSpec extends ToolingApiSpecification {
    ...
    def "can fetch model via model query"() {
        ...
        then:
        assertHelpTextHasSensibleContent(help)
    }
    ...
    private static void assertHelpTextHasSensibleContent(String help) {
        assert help.contains("To see help contextual to the project, use gradle help")
        assert help.contains("USAGE: gradle [option...] [task...]")
        assert help.contains("Shows this help message.")
    }
}
